...
Pour avoir les poids de notre modèle (fichiers trop gros pour être stockés sur Github), voir dans les fichiers Teams (dossier compressé backup).
Idem pour notre base de données d'images annotée (image&label). 
